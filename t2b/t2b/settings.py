"""
Django settings for t2b project.
...
SECRET_KEY = "django-insecure-@+%)6dsarz_7&*i^z9nq&*5-kph50gye01z+_i(w8(z%9@$*iu"
...
WSGI_APPLICATION = "t2b.wsgi.application"
...
DATABASES = {
    'default': {
        ...
        'NAME': 't2b',  # Replace with your database name
        'USER': 't2b',  # Replace with your database user
